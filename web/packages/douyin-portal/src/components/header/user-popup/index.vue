      ...
      <div class="user-menu-panel">
        <div class="popover-content">
          ...
          <div class="user-profile-actions">
            ...
            >
              <router-link to="/my?tab=likes" class="action-link-header">
            ...
            >
              <router-link to="/my?tab=record" class="action-link-header">
            ...
            >
              <router-link to="/my?tab=posts" class="action-link-header">
