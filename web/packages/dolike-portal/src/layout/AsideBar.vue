...
const isMyPage = computed(() => currentRoute.path.startsWith('/my'))
        ...
        <div class="douyin-navigation">
          <div class="nav-menu">
            <div
              ...
              :class="{ 'nav-menu__item--active': isMyPage }"
              @click="goToMyPage"
            >
              <div class="nav-menu__item-inner">
                <div
                  ...
                  :style="{
                    'background-position': isMyPage ? '-840px 0px' : '-816px 0px',
                ...
                <div class="nav-menu__title-wrapper">
                  <span class="nav-menu__title">我的</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="sidebar__footer">
            ...
            <a
              class="footer-action footer-action--link"
              title="DoLike"
              href="https://github.com/lovesakuratears/DoLike/issues/new"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg class="footer-action__icon footer-action__icon--github" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              class="footer-action footer-action--link"
              title="帮助"
              href="https://github.com/lovesakuratears/DoLike/blob/main/README.md"
              target="_blank"
              rel="noopener noreferrer"
            >
